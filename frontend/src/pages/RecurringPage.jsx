...
const AddRecurringForm = ({ categories, onSuccess }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg">
      <h3 className="text-xl font-semibold text-gray-700 mb-4">Tambah Transaksi Berulang</h3>
...
const RecurringPage = () => {
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold text-gray-800 mb-6">Transaksi Berulang</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-lg">
          <h3 className="text-xl font-semibold text-gray-700 mb-4">Jadwal Aktif</h3>
          <div className="space-y-4">
            {recurringTxs.length === 0 ? <p className="text-gray-500">Belum ada jadwal.</p> : null}
            {recurringTxs.map(tx => (
              <div key={tx.id} className="p-4 border rounded-lg flex justify-between items-center">
                <div>
                  <p className="font-bold text-gray-800">{tx.description || tx.category}</p>
